	...
	<form action=<%=ORSView.TIMETABLE_LIST_CTL %> method="post">
		...
		<table>
				<tr>
					...
					<%=HTMLUtility.getSList("courseId", String.valueOf(bean.getCourseId()), list1)%>&emsp;
					
					<label class="p1">Subject Name</label> 
					<%=HTMLUtility.getSList("subId", String.valueOf(bean.getSubId()), list2)%>&emsp;
			...
			<table border="1px" width="100%">
				...
				<tr>
					<td align="center"><input type="checkbox" name="ids" onclick="checkAl(this)"
						value="<%=DataUtility.getStringData(bean1.getId())%>"></td>
