        ...
        <center>
            ...
            <table align="center" style="margin-left: 40%" style="margin-right: 40%" >
                ...
                <tr>
                    ...
                    <td><input type="password" name="confirmPassword" placeholder="Confirm Password" value="<%=DataUtility.getStringData(bean.getConfirmPassword())%>">
  			...
  			<font color="red"> <%=ServletUtility.getErrorMessage("gender", request)%></font>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="mobile" placeholder="Mobile No"  maxlength="10"  value="<%=DataUtility.getStringData(bean.getMobileNo())%>">
                    <font
