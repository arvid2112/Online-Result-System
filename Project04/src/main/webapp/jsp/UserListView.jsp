...
<body>
	...
	<form action="<%=ORSView.USER_LIST_CTL%>" method="post">
		...
		<center>
			...
			<input type="text" name="firstName" placeholder="First Name" value="<%=ServletUtility.getParameter("firstName",request)%>">&emsp; 
			
			<label><b>Login Id:</b></label> 
			<input type="text" name="login" placeholder="LoginId" value="<%=ServletUtility.getParameter("login", request)%>">&emsp; 
						
			<label><b>Role</b></label> <%=HTMLUtility.getSList("roleId", String.valueOf(bean.getRoleId()), l)%>
