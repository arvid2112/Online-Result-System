    ...
    protected boolean validate(HttpServletRequest request) {
		...
		// System.out.println("inside isnull of mobileNo");
			...
			pass = false;
				 ...
				 request.setAttribute("mobileNo", PropertyReader.getValue("error.length", "Mobile No"));
				 pass=false;
		}
      ...
      //  System.out.println(request.getParameter("collegeId"));
		...
		{
	//		System.out.println("inside isnull collegeId");
			request.setAttribute("collegeId", PropertyReader.getValue("error.require", "CollegeId"));

			pass = false;
		}

		else if (!DataValidator.isInteger(request.getParameter("collegeId"))) {
			request.setAttribute("collegeId", PropertyReader.getValue("error.integer", ""));
			pass = false;
		}
